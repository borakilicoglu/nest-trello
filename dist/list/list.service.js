...
let ListService = class ListService {
    ...
    toResponseObject(list) {
        return Object.assign(Object.assign({}, list), { author: list.author && list.author.toResponseObject() });
    }
    ...
    create(boardId, userId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const list = yield this.listRepository.create(Object.assign(Object.assign({}, data), { board, author: user }));
