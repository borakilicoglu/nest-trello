...
let CommentController = class CommentController {
    ...
    showCommentsByCard(card, page) {
        return this.commentService.showByCard(card, page);
    }
    createComment(card, user, data) {
        return this.commentService.create(card, user, data);
    }
...
__decorate([
    common_1.Get('card/:id'),
    __param(0, common_1.Param('id')), __param(1, common_1.Query('page')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", void 0)
], CommentController.prototype, "showCommentsByCard", null);
__decorate([
    common_1.Post('card/:id'),
