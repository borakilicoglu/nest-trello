...
let CardService = class CardService {
    ...
    toResponseObject(card) {
        return Object.assign({}, card, { author: card.author && card.author.toResponseObject() });
    }
    ...
    create(listId, userId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const card = yield this.cardRepository.create(Object.assign({}, data, { list, author: user }));
